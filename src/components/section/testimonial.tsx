          ...
          <CardBody className="col-span-full gap-10 place-items-center overflow-visible grid grid-cols-1 lg:grid-cols-4">
            ...
            <div className="col-span-2 w-full">
              ...
              <Typography className="mb-1 w-full font-normal !text-gray-500">
                Become a versatile developer by combining frontend and backend skills. Build complete web applications
              ...
              <div className="grid mb-4">
                ...
                <div className="flex items-center gap-2">
                  <span className="h-1 w-1 bg-gray-500 rounded-full" />
                  {/* @ts-expect-error */}
                  <Typography className="w-full font-normal !text-gray-500">Certified include</Typography>
                </div>
              </div>
              <div className="flex items-center mt-8 gap-4">
                {/* @ts-expect-error */}
                <Avatar variant="circular" src="/image/avatar3.jpg" alt="spotify" size="md" />
                <div>
                  {/* @ts-expect-error */}
